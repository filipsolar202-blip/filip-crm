...
Hlavní CRM má jednu aplikační logiku a společný modrý glass vzhled. Verze opravuje časový test fondů na přesný počet měsíců od nákupu nebo emise a ukazuje termín u každé pozice i v klientském reportu. Přehled změn je v `CHANGELOG.md`, výsledky ověření v `QA-2026-09-16.md`.
